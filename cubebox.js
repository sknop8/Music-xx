...
function init() {
  ...
  //Initialize sky and ground to desert scene
...
/**
  * If static, rotates the scene (if on). If not static, adjusts the speed and moves forward (if on).
  */
function move() {
  if (static) {         
    if (on) {
...
/**
  * Resets the position of the ground
  */
